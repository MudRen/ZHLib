...
int perform(object me, object target)
{
        ...
        if (me->query_skill_mapped("force") != "hunyuan-yiqi" &&
            ...
            me->query_skill_mapped("force") != "jiuyang-shengong")
                return notify_fail("你使用的非少林内功，无法施展「大金刚神通」！\n");
	...
	d_count = (int)me->query("dex") / 2;
        ...
        {       
                ...
                me->start_call_out((: call_other, __FILE__, "remove_effect", me, count , d_count :), skill);
        ...
        } else
        {
                ...
                me->start_call_out((: call_other, __FILE__, "remove_effect", me, count * 3, 0 :), 2);
