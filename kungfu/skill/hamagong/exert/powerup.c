...
int exert(object me, object target)
{
    ...
    if(me->query("family/family_name") == "欧阳世家" || me->query("tianmo_jieti/times")>0)
	{
                me->set( "eff_qi",me->query("eff_qi")+skill*3 );
		  me->add("qi",skill*2);
	}
//	me->add_temp("apply/dodge",  skill/2);
	me->set_temp("powerup", 1);

	me->start_call_out( (: call_other, __FILE__, "remove_effect", me, skill/3, skill/5 :), skill);
...
void remove_effect(object me, int amount, int amount1)
{
	...
	if( me->query("family/family_name") == "欧阳世家" && me->query("eff_qi") > me->query("max_qi") )
	{
                me->set( "eff_qi",me->query("eff_qi")-amount*9+3 );
