...
mapping *action = ({
        ...
        ([      "action": "$N打得兴起，大喝一声：看我这招「龙虎相交」！左手往$n身后一抄，右拳便往$n面门砸了过去",
                "dodge": 5,
                "parry": 5,
                "force": 120,
                "skill_name" : "龙虎相交",
        ...
        ([      "action": "只见$N运足气力，一连三拳击向$n$l，力道一拳高过一拳！这一招的名字还相当高雅，叫作「阳关三叠」",
                "dodge": 5,
                "parry": 5,
                "force": 80,
                "skill_name" : "阳关三叠",
        ...
        ([      "action": "$N飞身跃起，正是一招「苍鹰捕鼠」，半空中一脚踢向$n面门，却是个虚招。说时迟那时快，只见$N一个倒翻，双掌已到了$n的$l",
                "dodge": 5,
                "parry": 5,
                "force": 100,
                "skill_name" : "",
