...
#include <ansi.h>
#include "songshan.h"
#define CANYANG "/clone/lonely/canyang"  //Add by PLZW 2004-6-7
...
void attempt_apprentice(object ob)
{
	...
	if ((int)ob->query("combat_exp") < 360000)
	{
        ...
        if ((int)ob->query_skill("songshan-sword", 1) < 150)
	{	
        ...
        if ((int)ob->query_skill("songshan-xinfa", 1) < 150)
	{
