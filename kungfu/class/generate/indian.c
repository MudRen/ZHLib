...
string challenge()
{
        set("opinion/msg", ({
                (random(2) ? "此人来头不小，当年达摩祖师便是来自天竺。"
                           : "这是天竺高手，和少林派乃是同源。"),
                (random(2) ? "去天竺路途遥远，十分凶险，来到华夏大是不易。"
                           : "天竺瑜珈术奥妙无穷，少林绝学易筋经便是由此化来。"),
                (random(2) ? "当初达摩祖师来到华夏，带来了十二项绝技，实在是非同小可。"
...
void lost()
{
        ...
        message_vision(HIY "$N" HIY "双手合十，叹道：“华夏武学真是博大精深，这" +
