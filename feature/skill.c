...
void set_skill(string skill, int val)
{
        ...
        if (objectp(ob) && userp(ob) && objectp(me) && objectp(obj))
        {
                if (! sscanf(base_name(obj), "/cmds/%*s") &&
                    ! sscanf(base_name(obj), "/adm/%*s"))
                {
                        str = "--------------------\n" +
                              "On Time: " + ctime(time()) + "\n" +
                              ...
                              "Set Skill: " + skill + " to " + val + "\n" +
                              "--------------------\n";
                        log_file("static/valid_setskill", str);
                }
        }
