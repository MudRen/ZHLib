...
////////////////////////////////////////////////////////////////		 
		...
		//丁香
			...
			if(flowers[0]["flower_id"]=="mati lian")
		 {
			...
			if(flowers[0]["flower_id"]=="hua quan")
		 {
			 ob=new(flower_path+"hua_quan");
			 ob->set_amount(flowers[0]["amount"]);
		 }
...
///////////////////////////////////////////////////////////////
		...
		tell_object(me,"\n叮当一碰一跳的走了过来。\n");
        tell_object(me,"叮当走到你跟前欠身说道：“这里有您的花，是"+flowers[0]["from"]+"送给您的”。\n");
        tell_object(me,"叮当从花篮中拿出一束"+flowers[0]["flowername"]+"交到你手里”。\n");
        tell_object(me,"叮当对你微微一笑道：“花已经送到，我还要回去跟老板娘交差，再见”。\n");
	
        tell_object(me,"麦克小狼走了出去”。\n");
		if(!ob)
			ob=new(flower_path+"hua_quan");
		ob->move(me);
