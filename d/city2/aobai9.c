...
LONG );
	...
	setup();
        ...
        get_object(__DIR__"obj/bishou");
        get_object(__DIR__"obj/baojia");
        get_object(__DIR__"obj/shouzhuo");
        get_object(__DIR__"obj/book14_7");
        get_object(__DIR__"obj/book14_1");
}
