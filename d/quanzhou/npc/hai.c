...
int ask_for_gongzi()
{
        ...
        if (me->query("paytimes")<paytimes)
        {
            ...
            if (exp < 100000) payment->set_amount(5);
            else if (exp < 200000) payment->set_amount(10);
            else if (exp < 400000) payment->set_amount(20);
            else if (exp < 600000) payment->set_amount(30);
            else if (exp < 800000) payment->set_amount(40);
            else if (exp < 1000000) payment->set_amount(50);
            else if (exp < 1500000) payment->set_amount(60);
            else if (exp < 2000000) payment->set_amount(70);
            else if (exp < 2500000) payment->set_amount(80);
            else if (exp < 3000000) payment->set_amount(90);
            else payment->set_amount(100);
            payment->move(me);
            me->add("paytimes",1);
