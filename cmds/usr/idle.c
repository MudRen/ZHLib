...
int main(object me, string arg)
{
	...
	if (me == ob)
        ...
        if (me->is_busy())
                return notify_fail("你自己都忙不过来了还想让别人发呆？\n");
        if (me->is_fighting()) 
                return notify_fail("不至于吧？边战斗边令人发呆？还是等你打完再说吧！\n");
	...
	me->start_busy(2 + random(4));
        ...
        ob->ban_say_until(lvl < 180 ? lvl : 180, "你被吓傻了，现在说不上话来");
        write(HIC "你的发呆神功成功了，" + ob->name() +
              HIC "现在被吓得说不上话来了！\n" NOR);
