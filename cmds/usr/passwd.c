...
private void get_new_dj_pass(string pass, object ob)
{
        string old_pass;
	...
	write("\n请再输入一次新的管理密码：");
	input_to("confirm_new_dj_pass", 1, ob, crypt(pass, 0));
}

private void confirm_new_dj_pass(string pass, object ob, string new_pass)
{
        object me;
        object body;
        string email;
