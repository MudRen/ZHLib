...
int accept_object(object me, object who, object ob)
{
        ...
        } else
        {
                ...
                {
                        // 连续完成了超过500次的任务
                        exp += 800 + random(quest_count / 20 + 1);
                        pot += 450 + random(quest_count / 25 + 1);
                        mar = 200 + random(20);
                        weiwang += 8 + random(20);
                        score += 4 + random(15);
                        gongxian += random(2);
                ...
                {
                        // 连续完成了超过200次的任务
                        exp += 500 + random(quest_count / 20 + 1);
                        pot += 300 + random(quest_count / 25 + 1);
                        mar = 150 + random(10);
                        weiwang += 5 + random(15);
                        score += 3 + random(10);
                } else
                ...
                {
                        // 连续完成了超过100次的任务
                        exp += 200 + random(quest_count / 20 + 1);
                        pot += 150 + random(quest_count / 25 + 1);
                        mar = 100 + random(10);
                        weiwang += 3 + random(10);
                        score += 2 + random(10);
                } else
                ...
                {
                        // 连续完成了超过10次的任务
                        exp += 145 + random(quest_count / 20 + 1);
