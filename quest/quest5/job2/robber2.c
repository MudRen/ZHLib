...
void create()
{ 
        set_name("金兵将领",({"menggu jiangling","jiangling"}));
        set("long","这是一位侵犯中原的金兵将领。\n");
        set("gender", "男性" );
...
void die()
{
        ...
        {
        case 0:
                message_vision(HIR "城下又爬上来一个金兵兵士。\n" NOR, ob); 
                ...
                break;
        case 1:
                message_vision(HIR"城下又爬上来一个金兵将领。\n" NOR,ob); 
                ...
                break;
        case 2:
                message_vision(HIR"城下又爬上来一个金兵高手。\n" NOR,ob); 
